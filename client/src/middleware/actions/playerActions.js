...
// PUT Player
export const putPlayerRequest = (payload) => {
    return {
        type: getRequest(PLAYER_PUT_PLAYER),
        payload,
    };
};

export const putPlayerSuccess = (payload) => {
    return {
        type: getSuccess(PLAYER_PUT_PLAYER),
        payload,
    };
};

export const putPlayerFailure = (payload) => {
    return {
        type: getFailure(PLAYER_PUT_PLAYER),
        payload,
    };
};
// DELETE Player
