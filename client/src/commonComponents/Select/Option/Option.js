...
const Option = (props) => {
    ...
    const handleClickSingle = () => {
        ...
        setDisplayedValue(typeof children === 'undefined' ? 'undefined' : typeof children === 'object' ? label : children);
    ...
    const handleClickMultiple = () => {
        ...
        setDisplayedValue((prevState) => {
            const valueShowed = typeof children === 'undefined' ? 'undefined' : typeof children === 'object' ? label : children
